    ...
    >
      <nav className="container px-6 py-4 mx-auto">
        <div className="flex items-center justify-between">
          {/* <div className="text-2xl font-bold text-primary ">RK</div> */}
          <div class="text-2xl font-bold bg-linear-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
            RK
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 transition-colors duration-300 hover:text-primary hover:border-blue-600"
              aria-label="GitHub"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
