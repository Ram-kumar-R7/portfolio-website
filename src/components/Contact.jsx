const Contact = () => {
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "ramkumarr0742@gmail.com",
      link: "mailto:ramkumarr0742@gmail.com",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/ram-kumar-r-02a7562b3/",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "GitHub",
      url: "https://github.com/Ram-kumar-R7",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex justify-center gap-6 mb-8">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="text-gray-400 transition-all duration-300 hover:text-primary hover:scale-110"
